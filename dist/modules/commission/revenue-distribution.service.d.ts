...
export declare class RevenueDistributionService {
    ...
    constructor(connection: Connection, purchaseModel: Model<PurchaseDocument>, commissionModel: Model<CommissionDocument>, userModel: Model<UserDocument>, walletRepo: WalletRepository, settingsService: SettingsService);
